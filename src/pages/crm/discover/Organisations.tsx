...
const DiscoverOrganisations = () => {
  const { toast } = useToast();
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedOrganisations, setSelectedOrganisations] = useState<string[]>([]);
  const [organisations, setOrganisations] = useState<Organisation[]>(premierLeagueTeams);
  ...
  const handleAddToList = () => {
    if (selectedOrganisations.length === 0) {
      toast({
        title: "No Selection",
        description: "Please select organisations to add to your list.",
        variant: "destructive"
      });
      return;
    }
    ...
    toast({
      title: "Added to List",
      description: `Successfully added ${selectedOrganisations.length} ${selectedOrganisations.length === 1 ? 'organisation' : 'organisations'} to your list.`,
    });
    ...
    <div className="min-h-screen bg-gray-50 p-6" style={{ fontFamily: 'Poppins, sans-serif' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Discover Organisations</h1>
            <p className="text-gray-600 mt-1">Explore and discover Premier League football teams</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            >
              ...
              Add to My List ({selectedOrganisations.length})
            </Button>
          </div>
        </div>
...
export default DiscoverOrganisations;