          ...
          <Table className="w-full table-fixed">
            <TableHeader className="bg-sportbnk-navy">
              <TableRow>
                ...
                <TableHead className="cursor-pointer text-white w-[12%]" onClick={() => handleSort("position")}>
                  <div className="flex items-center gap-1">
                    Position
                    {sortField === "position" && (
                      sortDirection === "asc" ? <ArrowUp className="h-4 w-4" /> : <ArrowDown className="h-4 w-4" />
                ...
                <TableHead className="cursor-pointer text-white w-[16%]" onClick={() => handleSort("team")}>
                  <div className="flex items-center gap-1">
                    Team
                    {sortField === "team" && (
                      sortDirection === "asc" ? <ArrowUp className="h-4 w-4" /> : <ArrowDown className="h-4 w-4" />
                ...
                <TableHead className="cursor-pointer hidden md:table-cell text-white w-[12%]" onClick={() => handleSort("sport")}>
                  <div className="flex items-center gap-1">
                    Sport
                    {sortField === "sport" && (
                      sortDirection === "asc" ? <ArrowUp className="h-4 w-4" /> : <ArrowDown className="h-4 w-4" />
                ...
                <TableHead className="text-white w-[22%]">Email</TableHead>
